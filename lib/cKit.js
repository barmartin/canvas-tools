...
var src_app = function (require, core, constants, Vector, CPoint, PetalFlower, mainLoop, canvasEvents, sceneEvents, objectEvents, settingsEvents) {
    'use strict';
    var kit = core;
    ...
    return window.kit;
  }({}, core, constants, Vector, CPoint, PetalFlower, mainLoop, canvasEvents, sceneEvents, objectEvents, settingsEvents);
