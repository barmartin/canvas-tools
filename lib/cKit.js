/*! cKit.js v0.0.2 October 23, 2014 */
    ...
    cKit.prototype.updateSegment = function (delta) {
      ...
      for (var i = 0; i < this.objList.length; i++) {
        ...
        this.each(this.keyFrames[keyTo].obj[i].controlPoints, function (cp) {
          var newX = kit.keyFrames[kit.segment - 1].obj[i].controlPoints[index].x * (1 - sig) + cp.x * sig;
          var newY = kit.keyFrames[kit.segment - 1].obj[i].controlPoints[index].y * (1 - sig) + cp.y * sig;
